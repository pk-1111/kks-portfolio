...
const StarBadge = () => {
    return (
        <button className="group relative dark:bg-neutral-800/20 bg-neutral-200 rounded-full p-px overflow-hidden">
            ...
            <span className="flex items-center justify-center gap-1 relative z-[1] dark:bg-blue-900/60 bg-neutral-50/90 rounded-full py-2 px-4 pl-2 w-full">
