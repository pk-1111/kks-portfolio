    ...
    const services = [
        {
            ...
            icon: "fa-laptop", // Fixed icon class consistency
        },
        {
        ...
        },
        {
            ...
            icon: "fa-github", // Using brand icon
        }
    ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl w-full">
                {services.map((service, index) => (
                    <div key={index}
                        ...
                        {/* Description - Slate-200 for better legibility than gray-400 */}
